...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const getProjectSlug = (project) => {
    if (project.name === "Nexspace") return "nexspace";
    if (project.slug && project.slug !== "commercial-nexspace") return project.slug;
    return toProjectSlug(project.name);
  };

  const projectDetailHref = (project, category) => {
    const slug = getProjectSlug(project);
    if (slug === "nexspace") return "commercial/commercial-nexspace.html";
    return `${category}/${slug}.html`;
  };

  const bindListingPlusNavigation = (grid) => {
    grid?.addEventListener("click", (e) => {
      const plusBtn = e.target.closest(".listing-plus-btn");
      if (!plusBtn) return;
      e.preventDefault();
      e.stopPropagation();
      const link = plusBtn.closest("a[href]");
  ...
  const initResidentialPage = () => {
    ...
    const projects = [
      { name: "Crown Residences at Godrej Golf Links", slug: "crown-residences-at-godrej-golf-links", location: "Greater Noida, Noida", city: "noida", type: "apartment", status: "new-launch", budget: "premium", ready: false, price: "INR 2.85 Cr. onwards", possession: "Feb 2031", bhk: "3 & 4 BHK", badge: "New Launch", img: "images/godrej-golf-link.webp" },
      { name: "Godrej Astra", slug: "godrej-astra", location: "Sector 54, Gurugram", city: "gurgaon", type: "apartment", status: "new-launch", budget: "luxury", ready: false, price: "INR 10.34 Cr. onwards", possession: "Jan 2031", bhk: "3 & 4 BHK", badge: "New Launch", img: "images/e5aa86f4-f70f-46af-b39d-4bd91de720e2.webp" },
      { name: "Godrej Vanantara", slug: "godrej-vanantara", location: "Bannerghatta, Bengaluru", city: "bangalore", type: "apartment", status: "new-launch", budget: "mid", ready: false, price: "INR 1.28 Cr. onwards", possession: "Dec 2030", bhk: "2, 3 & 4.5 BHK", badge: "New Launch", img: "images/banner-section-550x550-cml7n8sp3000axbor6qdx1rzq-cmlj2m3km000zt5ph8d0j1m7v.webp" },
      { name: "Godrej Meridien", slug: "godrej-meridien", location: "Sector 106, Gurugram", city: "gurgaon", type: "apartment", status: "under-construction", budget: "mid", ready: false, price: "INR 1.62 Cr. onwards", possession: "Jan 2025", bhk: "1, 2 & 3 BHK", badge: "Under Construction", img: "images/44ab5a60-484f-4845-89fb-7a894292b8db.webp" },
      { name: "Godrej Altus", slug: "godrej-altus", location: "Vastrapur, Ahmedabad", city: "ahmedabad", type: "apartment", status: "new-launch", budget: "premium", ready: false, price: "Available on Request", possession: "Oct 2031", bhk: "3 & 4 BHK", badge: "New Launch", img: "images/ahemdabad.webp" },
      { name: "Godrej Aveline", slug: "godrej-aveline", location: "Yelahanka, Bengaluru", city: "bangalore", type: "apartment", status: "new-launch", budget: "mid", ready: false, price: "INR 2.53 Cr. onwards", possession: "Mar 2031", bhk: "3, 3.5 & 4.5 BHK", badge: "New Launch", img: "images/aveline-landing-page-final-550-x-550-project-thumbnail-image-cmmoklhge000qv9phgsrt26nt.webp" },
      { name: "Godrej Ivara", slug: "godrej-ivara", location: "Kharadi, Pune", city: "pune", type: "apartment", status: "new-launch", budget: "mid", ready: false, price: "INR 1.25 Cr. onwards", possession: "Jul 2032", bhk: "2, 3 & 4 BHK", badge: "New Launch", img: "images/1-elevation-view-cmlz308qv000i0wor1ftgevmg-cmmd38ceg0040cdph88ddfxy8.webp" },
      { name: "Godrej Horizon", slug: "godrej-horizon", location: "Dadar - Wadala, Mumbai", city: "mumbai", type: "apartment", status: "under-construction", budget: "premium", ready: false, price: "INR 5.67 Cr. onwards", possession: "Jun 2027", bhk: "3 BHK", badge: "Under Construction", img: "images/740b4f4c-2297-4f33-87a2-3eda7af4711d.webp" },
      { name: "Godrej Parkshire", slug: "godrej-parkshire", location: "Whitefield-Hoskote, Bengaluru", city: "bangalore", type: "apartment", status: "new-launch", budget: "mid", ready: false, price: "INR 1.18 Cr. onwards", possession: "Nov 2030", bhk: "2 & 3 BHK", badge: "New Launch", img: "images/banner-section-550x550-cml7n8sp3000axbor6qdx1rzq-cmlj2m3km000zt5ph8d0j1m7v.webp" },
      { name: "Godrej Connaught One", slug: "godrej-connaught-one", location: "Connaught Place, New Delhi", city: "delhi", type: "apartment", status: "under-construction", budget: "luxury", ready: false, price: "INR 18.61 Cr. onwards", possession: "May 2025", bhk: "3 BHK", badge: "Under Construction", img: "images/a40702e6-3019-4e58-86d9-a854eceb6590.webp" },
      { name: "Godrej Regal Pavilion", slug: "godrej-regal-pavilion", location: "Rajendra Nagar, Hyderabad", city: "hyderabad", type: "apartment", status: "new-launch", budget: "mid", ready: false, price: "INR 1.99 Cr. onwards", possession: "Jul 2030", bhk: "3 & 4 BHK", badge: "New Launch", img: "images/thumbnail-image-550-x-550-cmeb44mnj0015c8ph41rz3y75.webp" },
      { name: "Godrej Arden", slug: "godrej-arden", location: "Sigma III, Noida", city: "noida", type: "apartment", status: "new-launch", budget: "premium", ready: false, price: "INR 3.46 Cr. onwards", possession: "May 2030", bhk: "3 & 4 BHK", badge: "New Launch", img: "images/550-x550pxl-01-cmli0rqmq000mt5ph32qt71fa.webp" },
      { name: "Godrej Vrikshya", slug: "godrej-vrikshya", location: "Sector 103, Gurgaon", city: "gurgaon", type: "apartment", status: "new-launch", budget: "premium", ready: false, price: "INR 3.81 Cr. onwards", possession: "Jun 2031", bhk: "3 & 4 BHK", badge: "New Launch", img: "images/bd519108-63a0-431c-9a3a-468ca7d6f366.webp" },
      { name: "Godrej Rejuve", slug: "godrej-rejuve", location: "Keshavnagar, Pune", city: "pune", type: "apartment", status: "ready", budget: "affordable", ready: true, price: "INR 65.74 L. onwards", possession: "Jan 2023", bhk: "2 BHK", badge: "Possession Ready", img: "images/rejuve.webp" },
      { name: "Godrej Blue", slug: "godrej-blue", location: "New Alipore, Kolkata", city: "kolkata", type: "apartment", status: "new-launch", budget: "mid", ready: false, price: "INR 2.49 Cr. onwards", possession: "Sep 2029", bhk: "3 & 4 BHK", badge: "New Launch", img: "images/d2c408b7-90d4-467c-9cad-a6affd72e95a.webp" },
      { name: "Godrej South Estate", slug: "godrej-south-estate", location: "Okhla, New Delhi", city: "delhi", type: "apartment", status: "under-construction", budget: "luxury", ready: false, price: "INR 6.14 Cr. onwards", possession: "May 2026", bhk: "3 & 4 BHK", badge: "Under Construction", img: "images/977a1e4f-349f-43d9-8aaf-836f73d5e4ff.webp" },
      { name: "Godrej Tiara", slug: "godrej-tiara", location: "Yeshwanthpur, Bengaluru", city: "bangalore", type: "apartment", status: "new-launch", budget: "luxury", ready: false, price: "INR 5.99 Cr. onwards", possession: "May 2030", bhk: "4.5 BHK", badge: "New Launch", img: "images/6b5d387b-d3e0-440d-8ffa-2ea54780551f.webp" },
      { name: "Godrej Exquisite", slug: "godrej-exquisite", location: "Thane, Mumbai", city: "mumbai", type: "apartment", status: "under-construction", budget: "mid", ready: false, price: "INR 2.35 Cr. onwards", possession: "Sep 2026", bhk: "3 BHK", badge: "Under Construction", img: "images/9142c7e4-3c14-4d83-ac9b-d18aa9717839.webp" },
    ];
    ...
    const renderCard = (project) => `
      <a href="${projectDetailHref(project, "residential")}" class="listing-card-link">
      <article class="listing-card" data-project="${project.name}" data-slug="${getProjectSlug(project)}">
        <div class="listing-img-wrap">
          ...
          <div class="listing-img-overlay">
            ...
            <button type="button" class="listing-plus-btn" title="View ${project.name}" aria-label="View details for ${project.name}">+</button>
          </div>
        </div>
    ...
    bindListingPlusNavigation(grid);
  ...
  const initCommercialPage = () => {
    ...
    const renderCard = (project) => `
      <a href="${projectDetailHref(project, "commercial")}" class="commercial-card-link">
        <article class="commercial-card" data-project="${project.name}" data-slug="${getProjectSlug(project)}">
  ...
  const initPlottedPage = () => {
    ...
    const projects = [
      { name: "Godrej Woodside Estate", slug: "godrej-woodside-estate", location: "Hinjewadi, Pune", city: "pune", state: "maharashtra", status: "new-launch", budget: "mid", price: "INR 1.25 Cr. onwards", possession: "Dec 2026", typeLabel: "Plots", badge: "New Launch", badgeClass: "", img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&q=90" },
      { name: "Godrej Woodscapes", slug: "godrej-woodscapes", location: "Devanahalli, Bengaluru", city: "bangalore", state: "karnataka", status: "new-launch", budget: "mid", price: "INR 1.60 Cr. onwards", possession: "Oct 2028", typeLabel: "Plots", badge: "New Launch", badgeClass: "", img: "https://images.unsplash.com/photo-1600607687644-c7171b42498f?w=900&q=90" },
      { name: "Godrej Reserve", slug: "godrej-reserve", location: "Devanahalli, Bengaluru", city: "bangalore", state: "karnataka", status: "new-launch", budget: "mid", price: "INR 1.80 Cr. onwards", possession: "Dec 2028", typeLabel: "Plots", badge: "New Launch", badgeClass: "", img: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&q=90" },
      { name: "Godrej Golf Links", slug: "godrej-golf-links", location: "Greater Noida, Noida", city: "noida", state: "uttar-pradesh", status: "under-construction", budget: "mid", price: "INR 1.70 Cr. onwards", possession: "Mar 2031", typeLabel: "Plots", badge: "Under Construction", badgeClass: "badge-dot--construction", img: "https://images.unsplash.com/photo-1600047509807-ba8f99d2cd7a?w=900&q=90" },
      { name: "Godrej Courtyard Shopense", slug: "godrej-courtyard-shopense", location: "Sanand, Ahmedabad", city: "ahmedabad", state: "gujarat", status: "under-construction", budget: "affordable", price: "INR 16.99 Lac onwards", possession: "Mar 2031", typeLabel: "Project", badge: "Under Construction", badgeClass: "badge-dot--construction", img: "https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&q=90" },
      { name: "Godrej Shantivan Eden Phase II (Pali)", slug: "godrej-shantivan-eden-phase-ii-pali", location: "Pali, Mumbai", city: "mumbai", state: "maharashtra", status: "under-construction", budget: "mid", price: "INR 1.18 Cr. onwards", possession: "Jan 2025", typeLabel: "Plots", badge: "Under Construction", badgeClass: "badge-dot--construction", img: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=900&q=90" },
      { name: "Godrej Golf Hills", slug: "godrej-golf-hills", location: "Sector 27, Gurugram", city: "gurgaon", state: "haryana", status: "new-launch", budget: "premium", price: "INR 4.75 Cr. onwards", possession: "Dec 2028", typeLabel: "Plots", badge: "New Launch", badgeClass: "", img: "https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=900&q=90" },
      { name: "Godrej Highland", slug: "godrej-highland", location: "Devanahalli, Bengaluru", city: "bangalore", state: "karnataka", status: "under-construction", budget: "premium", price: "INR 3.82 Cr. onwards", possession: "Dec 2033", typeLabel: "Plots", badge: "Under Construction", badgeClass: "badge-dot--construction", img: "https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=900&q=90" },
      { name: "Godrej MSR City", slug: "godrej-msr-city", location: "Shettigere, Bengaluru", city: "bangalore", state: "karnataka", status: "new-launch", budget: "affordable", price: "INR 79.56 Lac onwards", possession: "Dec 2026", typeLabel: "Plots", badge: "New Launch", badgeClass: "", img: "https://images.unsplash.com/photo-1600585152915-d208bec867a1?w=900&q=90" },
      { name: "Godrej Green Cove", slug: "godrej-green-cove", location: "Talegaon, Pune", city: "pune", state: "maharashtra", status: "new-launch", budget: "affordable", price: "INR 55 Lac onwards", possession: "Jun 2027", typeLabel: "Plots", badge: "New Launch", badgeClass: "", img: "https://images.unsplash.com/photo-1600047509358-9dc75507daeb?w=900&q=90" },
      { name: "Godrej Palm Retreat", slug: "godrej-palm-retreat", location: "Sector 150, Noida", city: "noida", state: "uttar-pradesh", status: "new-launch", budget: "mid", price: "INR 1.45 Cr. onwards", possession: "Sep 2028", typeLabel: "Plots", badge: "New Launch", badgeClass: "", img: "https://images.unsplash.com/photo-1600210492486-724fe41c1d4a?w=900&q=90" },
    ];
    ...
    const renderCard = (project) => `
      <a href="${projectDetailHref(project, "plotted")}" class="listing-card-link">
      <article class="listing-card" data-project="${project.name}" data-slug="${getProjectSlug(project)}">
        <div class="listing-img-wrap">
          <img src="${project.img}" alt="${project.name}" class="listing-img" loading="lazy" decoding="async" width="900" height="675">
          <div class="listing-img-overlay">
  ...
  const initProjectEnquireModal = () => {
    const modal = document.getElementById("project-enquire-modal");
    const form = document.getElementById("project-enquire-modal-form");
    const feedback = document.getElementById("project-enquire-feedback");
    const closeBtn = document.getElementById("project-enquire-modal-close");
    const projectField = document.getElementById("project-enquire-project");
    ...
    const openModal = (projectName) => {
      if (projectName && projectField) projectField.value = projectName;
      if (feedback) feedback.hidden = true;
      modal.classList.add("active");
      modal.setAttribute("aria-hidden", "false");
      document.body.style.overflow = "hidden";
      form.querySelector("#project-enquire-name")?.focus();
    };

    window.openProjectEnquireModal = openModal;
    ...
    form.addEventListener("submit", (e) => {
      e.preventDefault();
      const name = document.getElementById("project-enquire-name");
      const email = document.getElementById("project-enquire-email");
      const phone = document.getElementById("project-enquire-phone");
      const city = document.getElementById("project-enquire-city");
      ...
      const savedProject = projectField?.value || "";
      form.reset();
      if (projectField && savedProject) projectField.value = savedProject;
      setTimeout(closeModal, 1600);
    });
  };

  initProjectEnquireModal();
  ...
  const initDynamicProjectDetail = () => {
    ...
    const slugFromPage =
      ...
      root.dataset?.projectSlug ||
      "";
    const params = new URLSearchParams(window.location.search);
    const project = findProjectBySlug(slugFromPage || params.get("id") || "");
    if (!project) return;
    ...
    const projectImageSrc =
      /^https?:\/\//i.test(project.img) || project.img.startsWith("../")
        ? project.img
        : `${pageBasePath}${project.img}`;
    ...
    if (back) {
      back.href = `${pageBasePath}${project.listHref}`;
    ...
    if (listLink) {
      listLink.href = `${pageBasePath}${project.listHref}`;
    ...
    const projectEnquireField = document.getElementById("project-enquire-project");
    ...
    if (projectEnquireField) projectEnquireField.value = project.name;
