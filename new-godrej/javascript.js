document.addEventListener("DOMContentLoaded", () => {
  ...
  const goToNriHomeFestForm = () => {
    ...
    window.location.href = "nri-home-fest.html#nri-fest-form";
  };
  ...
  window.openBookYourPass = openVipModal;
  ...
  const initFooterLinks = () => {
    ...
    const goToListings = (city) => {
      ...
      const base = window.location.pathname.includes("/") ? "../index.html" : "index.html";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- Simple Enquire Now Modal (Name, Email, Phone, City) ---
  const ensureSimpleEnquireModal = () => {
    let modal = document.getElementById("project-enquire-modal");
    if (modal) return modal;

    modal = document.createElement("div");
    modal.className = "enquire-modal-overlay project-enquire-modal";
    modal.id = "project-enquire-modal";
    modal.setAttribute("aria-hidden", "true");
    modal.innerHTML = `
      <div class="enquire-modal-content project-enquire-modal-content" role="dialog" aria-labelledby="project-enquire-modal-title" aria-modal="true">
        <button type="button" class="enquire-modal-close" aria-label="Close" id="project-enquire-modal-close">&times;</button>
        <div class="enquire-modal-header">
          <h2 id="project-enquire-modal-title">Enquire Now</h2>
          <p>Share your details and our team will get back to you shortly.</p>
        </div>
        <form class="enquire-modal-form project-enquire-modal-form" id="project-enquire-modal-form" novalidate>
          <input type="hidden" id="project-enquire-project" value="">
          <label class="enquire-modal-field enquire-modal-field--full">
            <span>Name*</span>
            <input type="text" id="project-enquire-name" required autocomplete="name" placeholder="Your name">
          </label>
          <label class="enquire-modal-field enquire-modal-field--full">
            <span>Email*</span>
            <input type="email" id="project-enquire-email" required autocomplete="email" placeholder="Your email">
          </label>
          <label class="enquire-modal-field enquire-modal-field--full">
            <span>Phone*</span>
            <input type="tel" id="project-enquire-phone" required autocomplete="tel" placeholder="Your phone number">
          </label>
          <label class="enquire-modal-field enquire-modal-field--full">
            <span>City*</span>
            <input type="text" id="project-enquire-city" required autocomplete="address-level2" placeholder="Your city">
          </label>
          <div class="enquire-modal-submit-wrap">
            <button type="submit" class="enquire-modal-submit">Submit</button>
          </div>
          <p class="enquire-modal-feedback" id="project-enquire-feedback" hidden></p>
        </form>
      </div>
    `;
  ...
  const initSimpleEnquireModal = () => {
    const modal = ensureSimpleEnquireModal();
  ...
  initSimpleEnquireModal();

  const openEnquireModal = (projectName) => {
    initSimpleEnquireModal();
    if (typeof window.openProjectEnquireModal === "function") {
      window.openProjectEnquireModal(projectName);
    }
  };
